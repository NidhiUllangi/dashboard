  ...
  return (
    <div className=" col-span-2 min-h-[90vh] border-r border-gray-200 items-start justify-start flex flex-col w-full ">
      ...
      <div className="w-full items-start justify-start flex flex-col px-12 pt-12 pb-6">
        ...
        <div className="items-start justify-start flex flex-col px-6 pt-8 pb-4 bg-[#bd9fea] mt-6 w-full ">
          <h1> Nidhi Ullangi </h1>
          <h1 className=" text-3xl xl:text-5xl font-bold py-6 ">
            $ 920,434.00
          </h1>
        </div>
        <div className="bg-white py-4 px-8 w-full items-start justify-between flex shadow-2xl shadow-emerald-100rald-200 ">
          <span className="flex flex-col items-start justify-start text-black">
            <h1> Card Number </h1>
            <h3> **** **** **** 3711 </h3>
          </span>
